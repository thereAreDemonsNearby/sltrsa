...
sltrsa: sltrsa.cpp biguint.hpp ntalgo.hpp
	$(CXX) -O2 -std=c++17 -o bin/sltrsa sltrsa.cpp -pthread -lfmt
sltrsa_keygen: keyGen.cpp biguint.hpp ntalgo.hpp primegen.hpp
	$(CXX) -O2 -std=c++17 -o bin/sltrsa_keygen keyGen.cpp -pthread -lfmt
sltrsa_gprof: sltrsa.cpp biguint.hpp ntalgo.hpp
	$(CXX) -pg -O2 -std=c++17 -o profile/sltrsa sltrsa.cpp -pthread -lfmt
sltrsa_keygen_gprof: keyGen.cpp biguint.hpp ntalgo.hpp primegen.hpp
	$(CXX) -pg -O2 -std=c++17 -o profile/sltrsa_keygen keyGen.cpp -pthread -lfmt
